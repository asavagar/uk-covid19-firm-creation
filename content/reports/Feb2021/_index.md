...
The following graph illustrates the cumulative company registrations in January 2021 by industrial sector. For the analysis, we use 2-digit SIC levels (SIC divisions) and convert it to sectors (SIC sections). We use the [ONS classification](https://onsdigital.github.io/dp-classification-tools/standard-industrial-classification/ONS_SIC_hierarchy_view.html) for divisions and sections. We present a selection of notable sectors. 
